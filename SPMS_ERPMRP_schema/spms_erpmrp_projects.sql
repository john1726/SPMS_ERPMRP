...
CREATE TABLE `projects` (
  `ID` int DEFAULT NULL,
  `Project Name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `Owner` int DEFAULT NULL,
  `Customer` int DEFAULT NULL,
  `Category` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `Priority` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `Status` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `Begin` datetime DEFAULT NULL,
  `End` datetime DEFAULT NULL,
  `Budget` int DEFAULT NULL,
  `PO Number` int DEFAULT NULL,
