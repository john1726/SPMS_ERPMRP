...
--
-- Table structure for table `opportunities extended`
--

DROP TABLE IF EXISTS `opportunities extended`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `opportunities extended` (
  `ID` int DEFAULT NULL,
  ...
  `Forecast Value` double(53,30) DEFAULT NULL
