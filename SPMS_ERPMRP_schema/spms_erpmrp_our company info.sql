...
--
-- Table structure for table `our company info`
--

DROP TABLE IF EXISTS `our company info`;
...
CREATE TABLE `our company info` (
  ...
  `StateOrProvince` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  ...
  `FaxNumber` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL
